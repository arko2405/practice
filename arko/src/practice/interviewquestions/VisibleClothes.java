...
// question http://ccm.net/forum/affich-605237-c-program-question-count-the-clothes-visible
//see bottom for question
class VisibleClothes {
	public static void main(String[] args)
    {
        ...
        System.out.println(GetVisibleCount(input1, input2, input3));
    }

	public static int GetVisibleCount(int legthOfRope, int noOfClothes, int[][] positionOfClothes)
    {
        //Write code here
        int output1 = noOfClothes;
        
        int noOfClothesTemp = noOfClothes;
        Dictionary<Integer, Integer> secDict= null;
        for (int i = 0; i < noOfClothesTemp; i++)
        {
            int startValue = positionOfClothes[i][0];
            int length = positionOfClothes[i][1];
            int endValue = startValue + length;
            secDict = new Hashtable<>();
            ...
            for (int j = i + 1; j < noOfClothesTemp; j++)
            {
                int startValueTemp = positionOfClothes[j][0];
                int lengthTemp = positionOfClothes[j][1];
