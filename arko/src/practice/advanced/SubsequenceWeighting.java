...
// question : https://www.hackerrank.com/challenges/subsequence-weighting
public class SubsequenceWeighting {

	public static void main(String[] args) {
		//getMaxWeightUsingDPSameAsLIS();
		getMaxWeight();
	...
	// Gave Time limit exceeded for some cases
	private static void getMaxWeightUsingDPSameAsLIS() {
		Scanner sc = new Scanner(System.in);
		int t =  sc.nextInt();
		while(t-->0){
			Integer n = sc.nextInt();
